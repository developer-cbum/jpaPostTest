        ...
        <form id="post-form" action="/posts/write" method="post">
            <div class="write-wrap">
                    ...
                    <div class="form-control" type="file" id="formFile">
                        ...
                        <div class="file-plus-wrap">
                            <c:forEach items="${post.files}" var="file">
                                <div id="${file.id}" class="modify-file-wrap">
                                    <div class="file-wrap">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                             fill="currentColor" style="cursor:default"
                                        ...
                                        <a class="p-1 rounded" style="color:#0d6efd; font-size: 14px; cursor: default"
                                           href="">${file.fileName}
                                        </a><span style="font-size: 12px">(<fmt:formatNumber
                                            value="${file.fileSize/1024}" pattern=".00"/>KB)</span>
                                    </div>
                ...
                <div class="post-btn-container">
                    <button type="button" class="btn btn-primary register-btn">게시글 등록</button>
                </div>
            </div>
        </form>
    </section>
